...
Within 24 hours it had a thousand upvotes and a thousand comments on Hacker News. Not because the take was hot.
...
![An ornate vintage amber key dissolving into particles that reform as a plain generic skeleton key, both floating against dark teal](./promptable-career-erosion-ai/images/VISUAL_2_illustration_1.png)
*Specialized expertise dissolving into something interchangeable.*
...
He called that his first shock.
...
![An amber compass with a blank dial, the needle spinning freely with a motion trail, no cardinal directions visible](./promptable-career-erosion-ai/images/VISUAL_3_diagram_1.png)
*The needle spins. North is gone.*

The author's backup plan was debugging. Race conditions in distributed systems. Production incidents at 2 AM. The messy, intuition-driven work that separates seniors from juniors.
...
![Amber building blocks of varied shapes collapsing mid-motion into a single flat pale block](./promptable-career-erosion-ai/images/VISUAL_4_illustration_2.png)
*Complexity collapsing into uniformity.*
...
Except the industry is redefining those values.
...
The studies measure time-to-PR, task completion rates, defect counts. They do not measure what it feels like to realize the thing you spent a decade getting good at can be produced by a prompt.

The author does not claim AI will replace him. He is still employed. He still reviews code and steers the model. He calls himself an "off-the-shelf engineer" now, a description that carries more weight than any productivity metric.
