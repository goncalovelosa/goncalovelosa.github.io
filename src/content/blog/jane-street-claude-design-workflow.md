...
pubDate: 2026-06-08
category: "AI"
tags: ["Artificial Intelligence", "Design", "Software Engineering", "Technology", "Programming"]
...
![A flat bridge being built from two sides, amber drafting triangles on the left meeting amber code blocks on the right](./jane-street-claude-design-workflow/images/VISUAL_2_illustration_1.png)
*Two worlds building toward each other.*

Jane Street is an edge case. Quant firm, unique tech stack, small tight-knit teams. One designer's workflow doesn't prove an industry shift. I know that.
...
Signups and valuations don't equal production usage. Most of these tools generate prototypes and weekend projects, skip enterprise software. But the direction is clear.
...
![A small amber door ajar in a large amber wall, three silhouette hands reaching through from the other side](./jane-street-claude-design-workflow/images/VISUAL_3_illustration_2.png)
*New participants reaching into the design space.*
...
Nielsen Norman Group put it bluntly: AI design tools are "not ready for prime time." A systematic literature review published by Wiley in 2025 warned of "potential overreliance on automation and a technology-first approach in developing AI design tools without involving designers."
...
His team's solution is cultural, not technical. He labels prototypes as "living proposal docs." The code is disposable. Reviewers give feedback on design and user experience, not code quality. Eventually, engineers take over the idea and implement it properly in a separate feature branch.
